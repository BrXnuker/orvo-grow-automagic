...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "ORVO — Automatización con IA para restaurantes" },
      { property: "og:description", content: "Más reservas, más clientes recurrentes, reputación impecable. Sistemas que trabajan por ti las 24 horas." },
